package monitorProcessosSO;

import java.io.*;
import java.util.StringTokenizer;

public class StartProcessosSO {
	...
	private String GetProcessListData() {
		...
		try {
			...
			// Read the processes from sysrtem and add & as delimeter for tokenize the
			// output
	...
	public static void main(String[] args) {
		StartProcessosSO gpl = new StartProcessosSO();
		gpl.showProcessData();
